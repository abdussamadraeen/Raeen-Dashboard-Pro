    ...
    if (currentSettingsState.backgroundType !== bgType || 
        ...
        if (bgType === 'canvas') {
            ...
            case 'google_dashboard':
                dom.bgLayer.innerHTML = `<iframe src="https://www.google.com" allow="forms; scripts; same-origin; popups; clipboard-write; gyp-eval; accelerometer; gyroscope;" style="width:100%;height:100%;border:none;pointer-events:auto;z-index:1;"></iframe>`;
                dom.bgLayer.style.backgroundImage = 'none';
                break;
